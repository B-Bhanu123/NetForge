"""
Automated Unit Test Suite - TestCoreBufferEventLoop
"""
import unittest
import sys
import os
...
class TestCoreBufferEventLoop(unittest.TestCase):
    """Test suite covering TestCoreBufferEventLoop functionality."""
    def setUp(self):
