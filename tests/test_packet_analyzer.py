"""
Automated Unit Test Suite - TestPacketAnalyzer
"""
import unittest
import sys
import os
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))
from netforge.analyzer.dpi_engine import DPIEngineComponent_1

class TestPacketAnalyzer(unittest.TestCase):
    """Test suite covering TestPacketAnalyzer functionality."""
    def setUp(self):
