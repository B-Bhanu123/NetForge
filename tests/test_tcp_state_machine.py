"""
Automated Unit Test Suite - TestTCPStateMachine
"""
import unittest
import sys
import os
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))
from netforge.protocols.tcp import TCPSegmentComponent_1

class TestTCPStateMachine(unittest.TestCase):
    """Test suite covering TestTCPStateMachine functionality."""
    def setUp(self):
