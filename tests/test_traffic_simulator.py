"""
Automated Unit Test Suite - TestTrafficSimulator
"""
import unittest
import sys
import os
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))
from netforge.simulator.routing import SimRoutingComponent_1

class TestTrafficSimulator(unittest.TestCase):
    """Test suite covering TestTrafficSimulator functionality."""
    def setUp(self):
